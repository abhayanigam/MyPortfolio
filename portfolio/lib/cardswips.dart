              ...
              child: Column(
                ...
                children: [
                  ...
                  if (index == 0) ...[
                    ...
                    Text(
                      "1. Engineered robust B2B and B2C solutions driving business growth using Flutter and Riverpod. "
                      "Implemented complex state management and responsive UI designs to ensure seamless user experiences across platforms.\n"
                      "\n2. Developed scalable web platforms with Next.js and Redux, ensuring high performance and SEO optimization. "
                      "Created dynamic, server-rendered applications that handle high traffic loads efficiently.",
                    ...
                    Text(
                      "Flutter · Riverpod · Next.js · Redux · Spring Boot · MySQL · PostgreSQL",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\n3. Architected secure backend systems using Spring Boot and optimized database interactions. "
                      "Designed RESTful APIs and microservices to support mobile and web frontends, ensuring data integrity and security.",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\nSKILLS : ",
                    ...
                    Text(
                      "Java · Spring Boot · Microservices · REST API · Database Management",
                      style: TextStyle(fontSize: 18),
                    ),
                  ],
                  if (index == 1) ...[
                    ...
                    Text(
                      "1. At 1team, a startup under Automation Simplified, my primary responsibilities revolve around backend development, "
                      ...
                      " I also engage in new feature development/Solving Bugs, alongside tasks like managing, reviewing, and cleaning up code, ensuring it meets quality standards.",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\nSKILLS : ",
                    ...
                    Text(
                      "Apache Camel · Apache ActiveMQ · MongoDB · Flutter · Dart · Java · Spring Boot And Spring MVC."
                      "Furthermore, I am adept at working with Xcode, Android Studio, Firebase, Sentry, and various other tools essential to our development process",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      ...
                      "thereby enhancing efficiency and communication within the school.",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\nSKILLS : ",
                    ...
                    Text(
                      "MongoDB · Java · Spring Boot And Spring MVC · Apache Cordova(For Android Development).",
                      style: TextStyle(fontSize: 18),
                    ),
                  ],
                  if (index == 2) ...[
                    ...
                    Text(
                      "1. Working with the Core Development Team on building the Salesken app, which enables salespeople to call customers, analyze their calls, "
                      ...
                      "and support comprehensive data analysis for better decision-making.",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\nSKILLS : ",
                    ...
                    Text(
                      "PostgreSQL · Git · Elasticsearch · Kibana · Java · Spring Framework · Maven · Agile Methodologies · Oauth2 · Zendesk & Pipedrive Api · CRM",
                      style: TextStyle(fontSize: 18),
                    ),
                  ],
                  if (index == 3) ...[
                    ...
                    Text(
                      "Worked with integration team, building backend java services for importing call records and their metadata Hands-on training in Spring MVC framework",
                      style: TextStyle(fontSize: 18),
                    ),
                    Text(
                      "\nSKILLS : ",
                    ...
                    Text(
                      "HTML · JS · JSP · Backend · REST web services & MVC Web Application Development · OAuth2 · Rest API",
                      style: TextStyle(fontSize: 18),
                    ),
                  ],
                ],
